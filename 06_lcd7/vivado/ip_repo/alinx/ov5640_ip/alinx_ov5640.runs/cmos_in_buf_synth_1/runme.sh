...
HD_PWD='Y:/project/zynq_ip_repo/alinx/ov5640_ip/alinx_ov5640.runs/cmos_in_buf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmos_in_buf.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cmos_in_buf.tcl
