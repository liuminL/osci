...
HD_PWD='Y:/project/zynq_ip_repo/alinx/ov5640_ip/alinx_ov5640.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alinx_ov5640.vds -m64 -mode batch -messageDb vivado.pb -notrace -source alinx_ov5640.tcl
