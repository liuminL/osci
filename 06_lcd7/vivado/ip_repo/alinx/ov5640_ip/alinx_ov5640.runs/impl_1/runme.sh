...
HD_PWD='Y:/project/zynq_ip_repo/alinx/ov5640_ip/alinx_ov5640.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alinx_ov5640.vdi -applog -m64 -messageDb vivado.pb -mode batch -source alinx_ov5640.tcl -notrace
